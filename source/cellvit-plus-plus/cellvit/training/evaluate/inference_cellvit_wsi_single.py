...
if __name__ == "__main__":
    ...
    experiment = CellViTInfExpDetection(
        logdir="/work/grana_urologia/MONKEY_challenge/source/sota_architectures/CellViT-plus-plus/model_test/2025-02-09T010646_cellvit++ sam-h finetuning",  # clf needs to be in the path: "logdir/checkpoints/model_best.pth"
        cellvit_path="/work/grana_urologia/MONKEY_challenge/source/sota_architectures/CellViT-plus-plus/checkpoints/VIT-256/CellViT-256-x40-AMP.pth",
