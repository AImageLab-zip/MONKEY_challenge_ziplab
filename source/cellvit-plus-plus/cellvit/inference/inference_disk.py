...
class CellViTInference:
    ...
    def _setup_worker(self) -> None:
        ...
        # ray.init(
        #     num_cpus=int(os.environ.get("SLURM_CPUS_PER_TASK", 8)) - 2,
        #     runtime_env=runtime_env,
        # )
        ray.init(num_cpus=os.cpu_count() - 3, runtime_env=runtime_env)

        # ray.init(num_cpus=8, runtime_env=runtime_env)
