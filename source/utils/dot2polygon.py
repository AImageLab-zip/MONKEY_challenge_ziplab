        ...
        if (A.get("PartOfGroup") == "lymphocytes") and (A.get("Type") == "Dot"):
            ...
            for child in A:
                ...
                for sub_child in child:
                    ...
                    sub_child.attrib["X"] = str(
                        float(x_value) - lymphocyte_half_box_size
                    )
                    sub_child.attrib["Y"] = str(
                        float(y_value) - lymphocyte_half_box_size
                    )
        ...
        if (A.get("PartOfGroup") == "monocytes") and (A.get("Type") == "Dot"):
            ...
            for child in A:
                for sub_child in child:
                    ...
                    sub_child.attrib["X"] = str(
                        float(x_value) - monocytes_half_box_size
                    )
                    sub_child.attrib["Y"] = str(
                        float(y_value) - monocytes_half_box_size
                    )
